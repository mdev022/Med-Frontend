            ...
            <div className="btn-group">
              <div className="dropdown">
                <input
                  ...
                  aria-label="Search"
                />
                <ul className={`dropdown-menu ${styles.searchDropdown}`} aria-labelledby="navbarDropdown">
                  {
              ...
              <span className={` dropdown-toggle ${styles.searchIcon}`}
                id="navbarDropdown" data-bs-toggle="dropdown"   onClick={()=> handleSearch()}> <SearchIcon /></span>
            </div>
          </form>
        </div>
      </div>
